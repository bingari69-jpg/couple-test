...
(function(){
  ...
  if(!window.__GATCHI_GUIDE_LOADER__ && analyticsScript && analyticsScript.src){
    ...
    guideData.src=new URL("guide-data.js?v=20260911-guide2",analyticsScript.src).href;
    guideData.onload=function(){
      const helpGuide=document.createElement("script");
      helpGuide.src=new URL("help-guide.js?v=20260911-guide2",analyticsScript.src).href;
