...
(function () {
  ...
  const CSS = `
@font-face{font-family:BetTitle;src:url('https://bingari69-jpg.github.io/couple-test/assets/fonts/jua-regular.woff2') format('woff2');font-display:swap}
...
.bet-reaction{display:flex;align-items:center;gap:8px;margin-top:12px;min-height:65px}.bet-reaction p{flex:1;border-radius:17px;background:#ffe6dc;padding:12px 10px;margin:0;font:17px/1.45 BetTitle,'Malgun Gothic',sans-serif;word-break:keep-all}.bet-mascot{width:62px;height:77px;flex:none;background-image:url('https://bingari69-jpg.github.io/couple-test/assets/art/game-characters.png');background-size:300% 100%;background-position:0 50%;background-repeat:no-repeat;mix-blend-mode:multiply;clip-path:inset(3%)}.game-page .bet-mascot{background-image:url('https://bingari69-jpg.github.io/couple-test/assets/art/catalog-mascots.png');background-size:300% 600%;background-position:var(--mascot-x) var(--mascot-y)}body[data-game=ten] .bet-mascot{background-image:url('https://bingari69-jpg.github.io/couple-test/assets/art/game-characters.png');background-size:300% 100%;background-position:50% 50%}
