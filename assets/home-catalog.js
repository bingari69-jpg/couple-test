...
const ITEMS = [
  ...
  { path:"t/snake/",      rel:"친구",  kind:"대결",
    title:"스네이크 40초 — 같은 먹이, 누가 더 많이 먹나",
    desc:"가고 싶은 쪽을 톡 누르면 방향이 바뀌어. 40초 동안 둘이 똑같은 자리에 똑같은 먹이." },
...
const CARDS = [
 ...
 ['snake','atlas',1,'#e2f2e6',['친구', '연인', '가족'],'40초, 같은 지렁이, 누가 더 많이 먹나'],
...
window.SOLO_GAMES={timejump:5,pairs:5,num25:5,mole:5,simon:5,snake:5,choseong:5,'2048':5,stack:5,mines:5,slide15:5,flap:5,typing:5,fit:5,'hidden-picture':3};
