...
(function(){
  ...
  const CARD_TITLES = {"ten": "10초 맞추기", "delivery": "배달 텔레파시", "mbti": "MBTI 맞히기", "react": "반응속도 대결", "crash": "20분 후 추락합니다", "seat": "어디에 앉나요", "marriage": "결혼 전에 맞춰볼 것들", "mind/fight": "싸우면 어떻게 끝날까", "memory": "우리의 기억", "ladder": "사다리타기", "groups": "골프 조편성", "num25": "1에서 25까지", "pairs": "짝 맞추기", "typing": "한글 타자 20초", "flap": "탭 비행", "timejump": "타임 점프", "slide15": "15퍼즐", "mines": "지뢰찾기 미니", "stack": "블록 쌓기", "2048": "2048 한판", "fit": "끼워넣기", "daily-word": "오늘의 단어", "snake": "스네이크 40초", "choseong": "초성 퀴즈", "simon": "순서 기억", "mole": "두더지 잡기", "ufo": "UFO 요격", "tap": "10초 연타", "stroop": "색깔 함정", "arrow": "화살표 함정", "stop": "딱 멈춰", "exam": "시험지 보내기", "rps": "가위바위보", "ranking": "내 취향 맞혀봐", "personality": "나와 너의 마음동물", "fortune": "오늘의 운세 카드", "tarot": "나와 너의 타로", "letter": "너에게 보내는 편지", "love-note": "나는 이렇게 주고, 이렇게 받고 싶어", "closeness": "우리에게 맞는 거리", "mirror": "내가 보는 나, 네가 보는 나"};
  const CARD_ROOT = "https://noljago.co.kr/assets/share-cards/";
  let loading = null;
  ...
  function loadResultNotify(){
    ...
    notifyLoading = new Promise(resolve=>{
      ...
      const src=current&&current.src ? new URL("result-notify.js?v=20260916-snake40",current.src).href : "../../assets/result-notify.js?v=20260916-snake40";
