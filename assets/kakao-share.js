...
(function(){
  ...
  function loadResultNotify(){
    ...
    notifyLoading = new Promise(resolve=>{
      ...
      const src=current&&current.src ? new URL("result-notify.js?v=20260913-games",current.src).href : "../../assets/result-notify.js?v=20260913-games";
