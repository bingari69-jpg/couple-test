(function(){
 ...
 async function sendLetter(textOnly=false){
   ...
   try{const url=madeUrl||urlFor(payload());if(await nativeShare(url))return;await loadShare();await window.kakaoShare({url,textOnly,btn:'편지 열어보기',img:'https://bingari69-jpg.github.io/couple-test/og/og-letter-sq.png',title:'너에게 편지가 도착했어요',desc:'봉투를 눌러 마음을 읽어보세요.'},copyLink);}
