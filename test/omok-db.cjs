...
async function createDB(){
 ...
 await db.exec(fs.readFileSync('supabase/migrations/20260914_omok_rooms.sql','utf8'));
 const args={create_omok_room:['p_name','p_request'],get_omok_room:['p_code'],join_omok_room:['p_code','p_name'],play_omok_move:['p_code','p_index','p_version'],resign_omok_room:['p_code','p_version'],rematch_omok_room:['p_code','p_round']};
